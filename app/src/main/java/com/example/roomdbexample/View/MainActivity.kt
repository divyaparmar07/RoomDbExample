...
import com.example.roomdbexample.Adapters.NoteAdapter
import com.example.roomdbexample.Model.Note
import com.example.roomdbexample.NoteApplication
import com.example.roomdbexample.R
import com.example.roomdbexample.ViewModel.NoteViewModel
import com.example.roomdbexample.ViewModel.NoteViewModelFactory
...
//                viewHolder.adapterPosition //position of a note
...
//                Toast.makeText(applicationContext, "Delete icon was clicked", Toast.LENGTH_SHORT)
//                    .show()
                showDialogMessage()
            }
        }
